...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">品牌详情示例</h2>
       <a class="fr top_rt_btn" href="dictoryUD.do" >对品牌的删、改</a>
      </div>
     <section>
     <form action="addDictory.do" method="post">
      <ul class="ulColumn2">
       <li>
       ...
       <li>
        ...
        <input type="text" class="textbox" name="dname" placeholder="品牌名称..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">目录描述：</span>
        <textarea rows="5"  cols="20" name="ddescription"></textarea>
       </li>
       <li>
